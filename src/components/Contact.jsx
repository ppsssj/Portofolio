    ...
    <section className="py-24 bg-background-light dark:bg-background-dark" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">{t.subheading}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
          ...
          >
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">{t.sendTitle}</h3>
            <p className="text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">{t.sendDescription}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white text-sm">{t.email}</div>
                  <a
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-semibold text-slate-900 dark:text-white text-sm">{t.location}</div>
                  <span className="text-slate-500 dark:text-slate-400 text-sm">{t.locationValue}</span>
                </div>
              </div>
            </div>
          </motion.div>
